...
delegated: React + TypeScript + Vite, with local structured content and no backend for the first review build. The content model must remain portable to future games.
...
- User-provided ChatGPT share conversation: https://chatgpt.com/share/6a8d3780-993c-83ec-834f-ec77a996b07a?ogimg=plain
- The reference contains chapter-based full-spoiler analysis, [确定]/[很可能] certainty markers, character and moral analysis, base-game/DLC comparisons, ending analysis, and a reusable way to analyze other games.
- No licensed game artwork has been supplied. The first build should use authored interface graphics, diagrams, and typography; external game art remains replaceable content rather than an assumed asset.
